...
export const container = `${theme.layout.container} flex flex-col-reverse lg:flex-row py-6 px-10 gap-12 h-[600px]`;
...
export const image = `flex flex-1 justify-center`;
